...
public class Main extends Application {
    ...
    public void start(Stage window) {
        // Create a Bank object with a mix of account types
        Bank bank = new Bank();
        if (!bank.hasAccounts()) {
            bank.addBankAccount(new StudentAccount("10001", "11111", 100, 80));
            bank.addBankAccount(new PrimeAccount("10002", "22222", 50, 500));
            bank.addBankAccount(new SavingAccount("213", "09", 1000000, 0.03));
        }
